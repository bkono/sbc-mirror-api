...
//}
//
//class CredentialDataStoreFactory(implicit system: ActorSystem) extends DataStoreFactory {
...
//}
//
//class CredentialDataStoreActorProxy[V <: io.Serializable](val actor: ActorRef, val factory: CredentialDataStoreFactory) extends DataStore[V] {
